...
Using the technology briefly presented in sections \ref{uwb} and \ref{rtls} a locating system has been developed by ... INDIQUER LE NOM DES ETUDIANTS PRECEDENTS (Cedric, Quentin ?) ... [AJOUTER LES REFERENCES].
