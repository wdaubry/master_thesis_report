...
\caption{\label{fig:dist_clut_room}}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=.9\linewidth]{Images/sla_cluttered_lot.png}
\caption{\label{fig:dist_lot_clut_room}}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Images/cir_success_comparison.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{Images/cir_failed_comparison.png}
